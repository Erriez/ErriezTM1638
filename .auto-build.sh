...
function autobuild()
{
    ...
    platformio ci --lib="." ${BOARDS_AVR} ${BOARDS_ESP} examples/ErriezTM1638/ErriezTM1638.ino
    platformio ci --lib="." ${BOARDS_AVR} ${BOARDS_ESP} examples/ErriezTM1638Benchmark/ErriezTM1638Benchmark.ino
}
